...
public class SaccountImpl implements SaccountService{
	...
	public DepositResponse deposit(long acc, int amount) {
		...
		try {
			...
			dao.save(account);
			response.setResponseMessage(""+amount+" $ successfully deposited into your account balance is now Rs."+account.getBalance());
	...
	public WithdrawResponse withdraw(long acc, int amount) {
		...
		try {
			...
			if(account.getBalance()>=amount) 
				...
				dao.save(account);
				response.setResponseMessage(""+amount+" $  successfully withdrawn your account balance is now Rs."+account.getBalance());
